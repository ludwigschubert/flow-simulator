...
def batch(iterable: Iterable[Any], n: int = 1) -> Iterable[Any]:
    current_batch = []
...
from flow.typing import Bindings, BindingsToStrings


def stringify_bindings(bindings: Bindings) -> BindingsToStrings:
